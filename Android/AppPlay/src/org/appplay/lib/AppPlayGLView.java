			...
			public void handleMessage(final Message msg) 
			{
				switch (msg.what)
				{
					case HANDLER_OPEN_IME_KEYBOARD:					
						...
						if (null != AppPlayGLView.this.mEditText && AppPlayGLView.this.mEditText.requestFocus()) 
						{
							AppPlayGLView.this.mEditText.removeTextChangedListener(AppPlayGLView.msTextInputWraper);
							...
							AppPlayGLView.this.mEditText.addTextChangedListener(AppPlayGLView.msTextInputWraper);
							
							final InputMethodManager imm = (InputMethodManager)
									AppPlayGLView.sTheAppPlayGLView.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
					...
					case HANDLER_CLOSE_IME_KEYBOARD:
						...
						if (null != AppPlayGLView.this.mEditText) 
						{
							...
							final InputMethodManager imm = (InputMethodManager) 
									AppPlayGLView.sTheAppPlayGLView.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
							imm.hideSoftInputFromWindow(AppPlayGLView.this.mEditText.getWindowToken(), 0);
    ...
    {	
        ...
        case MotionEvent.ACTION_POINTER_DOWN:
            ...
            queueEvent(new Runnable() 
            {
                public void run() 
                {
                	AppPlayNatives.nativeTouchPressed(idPointerDown, xPointerDown, yPointerDown);
                }
            });
            break;
        ...
        case MotionEvent.ACTION_POINTER_UP:
            ...
            queueEvent(new Runnable() 
            {
                ...
                public void run() 
                {
                	AppPlayNatives.nativeTouchReleased(idPointerUp, xPointerUp, yPointerUp);
                }
            });
            break;
